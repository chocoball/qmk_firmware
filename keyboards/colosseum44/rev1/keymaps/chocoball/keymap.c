...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT(
     ...
     * |     |      |      | MsUp |      |      |                |      |      |      |      | PGUP |  HOME |
     * |-----+------+------+------+------+------|                |------+------+------+------+------+-------|
     * |     |      |MsLeft|MsDown|MsRght|      |                |  ←   |  ↓   |  ↑   |  →   |PGDOWN|  END  |
     * |-----+------+------+------+------+------|                |------+------+------+------+------+-------|
     * |     |      |      |      |      |      |                |      |LCLICK|RCLICK|      |      |       |
     * `------------------------------------------------. ,-------------------------------------------------'
     *                      |      |      | LOWER|      | |       |RAISE |      |      |
  ...
  [_ADJUST] = LAYOUT(
   ...
   KC_TRNS,KC_F1, KC_F2, KC_F3,  KC_F4,  KC_F5,       RGB_TOG, RGB_MOD,   KC_NO,LCA(KC_DEL), LALT(KC_PSCR),KC_PSCR,
   KC_TRNS,KC_F6, KC_F7, KC_F8,  KC_F9, KC_F10,       RGB_VAD, RGB_VAI, RGB_HUD, RGB_HUI, RGB_SAD,  RGB_SAI,
